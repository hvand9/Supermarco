...
const BASE_CACHE_FILES = [
    'https://runtogether.sal-man.dk/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://runtogether.sal-man.dk/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://runtogether.sal-man.dk/',
];
...
const OFFLINE_PAGE = 'https://runtogether.sal-man.dk/';
const NOT_FOUND_PAGE = 'https://runtogether.sal-man.dk/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://runtogether.sal-man.dk//wp-admin/');
//    },
];
